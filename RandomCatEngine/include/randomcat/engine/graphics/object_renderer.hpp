...
namespace randomcat::engine::graphics {
    ...
    template<typename Object, typename SubRenderer>
    inline auto make_for_each_renderer(SubRenderer const& _subRenderer) {
        return for_each_object_renderer<Object, SubRenderer>(_subRenderer);
    }
}    // namespace randomcat::engine::graphics
