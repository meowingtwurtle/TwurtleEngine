...
namespace randomcat::engine::graphics {
    void camera::set_dir(float _yaw, float _pitch) {
    ...
    void camera::update_shader() {
        m_shader.uniform_set_mat4("view", glm::lookAt(m_pos, m_pos + m_dir, glm::vec3{0.0f, 1.0f, 0.0f}));
        m_shader.uniform_set_mat4("projection", glm::perspective(glm::radians(m_fov), m_aspectRatio, m_minDistance, m_maxDistance));
    }
}    // namespace randomcat::engine::graphics
